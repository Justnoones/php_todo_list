...
$template->header('Create', ['create2.css']);
?>

<form action="store.php" method="POST">
    <div class="row m-5">
        <div class="col-12">
            <h1 class="h2 text-light text-center my-4 fw-bold">Add New Plans</h1>
        </div>
        ...
        <div class="col-lg-10 col-12 mx-auto my-3">
            ...
            <div class="input-group">
                ...
                <div class="form-floating w-75">
                    <input type="text" name="task_title" id="task_title" class="form-control font"
                        placeholder="New Task" autocomplete="off" />
                    <label for="task_title" class="label text-light">Task Title</label>
                </div>
            </div>
            <?php endif?>
        ...
        <div class="col-lg-10 col-12 mx-auto my-3">
            <?php if (isset($_SESSION["old_dead_line"])): ?>
            <div class="input-group">
        ...
        <div class="col-4 mx-auto my-4 d-grid">
            <input type="submit" name="subbtn" id="submit-btn" class="btn text-light btn-primary" value="Add Task" />
        </div>
    </div>
</form>
